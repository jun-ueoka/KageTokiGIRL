//***********************************************************************************
//!	ファイル名		Class_BossTima.cpp
//
//	機能			アドベンチャーゲームモードの「ティマ」クラスの実装
//	記述			上岡　純
//	プロジェクト	[KageTokiGIRL]
//	更新			2009/02/16	<新規>
//***********************************************************************************
...
//#include	"Class_BossTima.h"		//!< アドベンチャーゲーム「ティマ」
...
namespace O3D
{
	...
	//	アニメーションの割り当てを行う(ティマ専用のクラスなので、、、)
		...
		this->iMaxLife					= TIMA_MAXLIFE;			//!< 最大体力
		this->iLife						= this->iMaxLife;		//!< 残り体力
		this->iHitFrame					= 0;					//!< 衝突して点滅する時間

	//	フラグ群
		this->action			= eBTIMAA_MAX;					//!< 最初は待機以外何でも良い
		this->changeAction(eBTIMAA_APPEAR);						//!< 初期状態は出現
	...
	//================================================================================
	//!	メソッド名	CBOSS_TIMA::soundJumpStart
	//
	//	機能		ジャンプ音管理
	//	更新		2009/02/16		<新規>
	//================================================================================
	...
	//================================================================================
	//!	メソッド名	CBOSS_TIMA::opeAppearWait
	//
	//	機能		出現待機時操作
	//	更新		2009/02/16		<新規>
	//================================================================================
	...
	//	新たな状態で追加処理があるならここで
		switch(this->action)
		{
			case	eBTIMAA_APPEAR:				//!< 出現時
				this->setAngleZ(0.0f);
				break;
			case	eBTIMAA_APPEAR_WAIT:			//!< 出現待機時
				this->setMoveQuantity(0.0f);
				this->setAngleZ(0.0f);
				break;
			case	eBTIMAA_WAIT:				//!< 待機時
				this->setMoveQuantity(30.0f);
				this->setAnimSpeed();
				this->setAngleZ(0.0f);
				break;
			case	eBTIMAA_DAMAGE:				//!< ダメージ反動時
	...
	//================================================================================
	//!	メソッド名	CBOSS_TIMA::reactionMessage
	//
	//	機能		リアクション
	//	更新		2009/02/16		<新規>
	//================================================================================
	...
	//================================================================================
	//!	メソッド名	CBOSS_TIMA::resetParameter
	//
	//	機能		パラメータのリセット
	//	更新		2009/02/18		<新規>
	//================================================================================
