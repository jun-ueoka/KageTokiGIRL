//***********************************************************************************
//!	ファイル名		Class_SceneMovie8.h
//
//	機能			ムービーシーンクラス、ムービー8[アジト?]の定義
//	記述			上岡　純
//	プロジェクト	「」
//	更新			2009/02/10	<新規>
//***********************************************************************************
...
namespace SCE
{
	...
	//!	クラス名		CSCENE_MOVIE8
	//
	//	機能			ムービーシーンクラス、ムービー8[アジト?]のクラス
	//	更新			2009/02/10	<新規>
	//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	class CSCENE_MOVIE8 : public CSCENE_MOVIE_BASE
	{
	private:		//-------------------- private --------------------//
	...
	public:			//-------------------- public --------------------//
				...
				CSCENE_MOVIE8(SCENE_SHARE_DATA* inData);
		virtual	~CSCENE_MOVIE8(void);
