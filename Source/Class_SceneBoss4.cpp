//***********************************************************************************
//!	ファイル名		Class_SceneBoss4.cpp
//
//	機能			ゲームシーンクラス、ボスステージ4「ティマ」を実装
//	記述			上岡　純
//	プロジェクト	「」
//	更新			2009/02/15	<新規>
//***********************************************************************************
...
{
	//================================================================================
	//!	メソッド名	CSCENE_BOSS4::CSCENE_BOSS4
	//
	//	機能		コンストラクタ
	//	引数		inData		シーン共有データ
	//	更新		2009/02/15	<新規>
	//================================================================================
	CSCENE_BOSS4::CSCENE_BOSS4(SCENE_SHARE_DATA* inData)	:
	//!	ゲームシーン
	CSCENE_ADVENTURE_GAME(eSCENE_LAST_CHAPTER_BOSS4, eSCENE_LAST_CHAPTER_MOVIE11,
	...
	//	更新		2009/02/15	<新規>
	//================================================================================
	CSCENE_BOSS4::~CSCENE_BOSS4(void)
	{
	//	解放
	...
	//================================================================================
	//!	メソッド名	CSCENE_BOSS4::scenecfdInitialize
	//
	//	機能		初期化
	...
	//================================================================================
	void
	CSCENE_BOSS4::sceneInitialize(int inStageNum)
	{
	//	デモ用のステージ番号を取得
		inStageNum	= 140;
	...
	//================================================================================
	//!	メソッド名	CSCENE_BOSS4::sceneFinishalize
	//
	//	機能		解放
	//	更新		2009/02/15	<新規>
	//================================================================================
	void
	CSCENE_BOSS4::sceneFinishalize(void)
	{
	//	解放
	...
	//================================================================================
	SCENE_FLAG
	CSCENE_BOSS4::sceneMain(CINPUT* input)
	{
	//	ゲームフラグで処理分岐
	...
	//================================================================================
	//!	メソッド名	CSCENE_BOSS4::updateLight
	//
	//	機能		ライトの更新
	//	更新		2009/02/15	<新規>
	//================================================================================
	void
	CSCENE_BOSS4::updateExecute(void)
	{
	}

	//================================================================================
	//!	メソッド名	CSCENE_BOSS4::sgCreateEnemy
	//
	//	機能		敵生成
	//	機能概要	敵を生成し、マップに登録する
	...
	//================================================================================
	void
	CSCENE_BOSS4::sgCreateEnemy(int inStageNum)
	{
	//	エクスを生成する
		if(	!this->bossExe)
		{
