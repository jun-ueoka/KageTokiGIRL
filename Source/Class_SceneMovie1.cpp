//***********************************************************************************
//!	ファイル名		Class_SceneMovie1.cpp
//
//	機能			ムービーシーンクラス、ムービー1[デート]の実装
//	記述			上岡　純
//	プロジェクト	「」
//	更新			2008/11/27	<新規>
//***********************************************************************************
...
namespace SCE
{
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE1::sceneInitialize
	//
	//	機能		初期化
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE1::sceneFinishalize
	//
	//	機能		解放
	//	更新		2009/01/27	<新規>
	//================================================================================
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE1::executeInstantChengeMovieSpeed
	//
	//	機能		ムービー処理速度変更時処理
	//	更新		2009/02/15	<新規>
	//================================================================================
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE1::executeProcOnce
	//
	//	機能		即時処理実行
	//	引数		inProc		処理番号
	//	更新		2009/01/27	<新規>
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE1::executeProc
	//
	//	機能		処理実行
	//	引数		inProc		処理番号
	//	更新		2009/01/27	<新規>
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE1::updateLight
	//
	//	機能		ライトの更新
	//	更新		2009/02/05	<新規>
	//================================================================================
