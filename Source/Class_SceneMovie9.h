//***********************************************************************************
//!	ファイル名		Class_SceneMovie9.h
//
//	機能			ムービーシーンクラス、ムービー9[はめられた!]の定義
//	記述			上岡　純
//	プロジェクト	「」
//	更新			2009/02/10	<新規>
//***********************************************************************************
...
namespace SCE
{
	...
	//!	クラス名		CSCENE_MOVIE9
	//
	//	機能			ムービーシーンクラス、ムービー9[はめられた!]のクラス
	//	更新			2009/02/10	<新規>
	//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	class CSCENE_MOVIE9 : public CSCENE_MOVIE_BASE
	{
	private:		//-------------------- private --------------------//
	...
	public:			//-------------------- public --------------------//
				...
				CSCENE_MOVIE9(SCENE_SHARE_DATA* inData);
		virtual	~CSCENE_MOVIE9(void);
