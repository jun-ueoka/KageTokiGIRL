//***********************************************************************************
//!	ファイル名		Class_SceneMovie12.cpp
//
//	機能			ムービーシーンクラス、ムービー12[本拠地発見]の実装
//	記述			上岡　純
//	プロジェクト	「」
//	更新			2009/02/10	<新規>
//***********************************************************************************
...
namespace SCE
{
	...
	//	更新		2009/02/10	<新規>
	//================================================================================
	CSCENE_MOVIE12::CSCENE_MOVIE12(SCENE_SHARE_DATA* inData)	:
	//!	ゲームシーン
	CSCENE_MOVIE_BASE(eSCENE_LAST_CHAPTER_ENDING_MOVIE, eSCENE_ENDING, inData)
	{
	//	初期化
		this->camera	= NULL;
		this->kageo		= NULL;
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE12::デストラクタ
	//
	//	更新		2009/02/10	<新規>
	//================================================================================
	CSCENE_MOVIE12::~CSCENE_MOVIE12(void)
	{
	//	解放
		sceneFinishalize();
	}
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE12::sceneInitialize
	//
	//	機能		初期化
	...
	//================================================================================
	void
	CSCENE_MOVIE12::sceneInitialize(int inStageNum)
	{
	//	ムービーの初期化
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE12::sceneFinishalize
	//
	//	機能		解放
	//	更新		2009/02/10	<新規>
	//================================================================================
	void
	CSCENE_MOVIE12::sceneFinishalize(void)
	{
	//	解放
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE12::sceneMain
	//
	//	機能		シーンメイン
	//	機能概要	ゲームシーンメイン
	//	引数		input		入力情報
	...
	//================================================================================
	SCENE_FLAG
	CSCENE_MOVIE12::sceneMain(CINPUT* input)
	{
	//	処理
		this->execute(input);
	//	描画
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE12::executeProcOnce
	//
	//	機能		即時処理実行
	//	引数		inProc		処理番号
	//	更新		2009/02/10	<新規>
	//================================================================================
	void
	CSCENE_MOVIE12::executeProcOnce(int inProc)
	{
	//	処理番号で分岐
		switch(inProc)
		{
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE12::executeProc
	//
	//	機能		処理実行
	//	引数		inProc		処理番号
	//	更新		2009/02/10	<新規>
	//================================================================================
	void
	CSCENE_MOVIE12::executeProc(int inProc)
	{
	//	処理番号で分岐
		switch(inProc)
		{
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE12::updateLight
	//
	//	機能		ライトの更新
	//	更新		2009/02/10	<新規>
	//================================================================================
	void
	CSCENE_MOVIE12::updateLight(void)
	{
	//	ライトの更新
	...
	//================================================================================
	void
	CSCENE_MOVIE12::execute(CINPUT* input)
	{
	//	即時処理データの更新処理
		this->checkProcOnce();
	//	処理データの更新処理
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE12::render
	//
	//	機能		描画
	//	更新		2009/02/10	<新規>
	//================================================================================
	void
	CSCENE_MOVIE12::render(void)
	{
	//	描画開始
