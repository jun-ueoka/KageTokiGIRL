//***********************************************************************************
//!	ファイル名		Class_SceneMovie10.cpp
//
//	機能			ムービーシーンクラス、ムービー10[脱出成功!]の実装
//	記述			上岡　純
//	プロジェクト	「」
//	更新			2009/02/10	<新規>
//***********************************************************************************
...
namespace SCE
{
	...
	//	更新		2009/02/10	<新規>
	//================================================================================
	CSCENE_MOVIE10::CSCENE_MOVIE10(SCENE_SHARE_DATA* inData)	:
	//!	ムービーシーン
	CSCENE_MOVIE_BASE(eSCENE_LAST_CHAPTER_MOVIE10, eSCENE_LAST_CHAPTER_STAGE10, inData)
	{
	//	初期化
		this->camera	= NULL;
		this->kageo		= NULL;
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE10::デストラクタ
	//
	//	更新		2009/02/10	<新規>
	//================================================================================
	CSCENE_MOVIE10::~CSCENE_MOVIE10(void)
	{
	//	解放
		sceneFinishalize();
	}
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE10::sceneInitialize
	//
	//	機能		初期化
	...
	//================================================================================
	void
	CSCENE_MOVIE10::sceneInitialize(int inStageNum)
	{
	//	ムービーの初期化
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE10::sceneFinishalize
	//
	//	機能		解放
	//	更新		2009/02/10	<新規>
	//================================================================================
	void
	CSCENE_MOVIE10::sceneFinishalize(void)
	{
	//	解放
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE10::sceneMain
	//
	//	機能		シーンメイン
	//	機能概要	ゲームシーンメイン
	//	引数		input		入力情報
	...
	//================================================================================
	SCENE_FLAG
	CSCENE_MOVIE10::sceneMain(CINPUT* input)
	{
	//	処理
		this->execute(input);
	//	描画
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE10::executeInstantChengeMovieSpeed
	//
	//	機能		ムービー処理速度変更時処理
	//	更新		2009/02/15	<新規>
	//================================================================================
	void
	CSCENE_MOVIE10::executeInstantChengeMovieSpeed(void)
	{
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE10::executeProcOnce
	//
	//	機能		即時処理実行
	//	引数		inProc		処理番号
	//	更新		2009/02/10	<新規>
	//================================================================================
	void
	CSCENE_MOVIE10::executeProcOnce(int inProc)
	{
	//	処理番号で分岐
		switch(inProc)
		{
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE10::executeProc
	//
	//	機能		処理実行
	//	引数		inProc		処理番号
	//	更新		2009/02/10	<新規>
	//================================================================================
	void
	CSCENE_MOVIE10::executeProc(int inProc)
	{
	//	処理番号で分岐
		switch(inProc)
		{
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE10::updateLight
	//
	//	機能		ライトの更新
	//	更新		2009/02/10	<新規>
	//================================================================================
	void
	CSCENE_MOVIE10::updateLight(void)
	{
	//	ライトの更新
	...
	//================================================================================
	void
	CSCENE_MOVIE10::execute(CINPUT* input)
	{
	//	即時処理データの更新処理
		this->checkProcOnce();
	//	処理データの更新処理
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE10::render
	//
	//	機能		描画
	//	更新		2009/02/10	<新規>
	//================================================================================
	void
	CSCENE_MOVIE10::render(void)
	{
	//	描画開始
