//***********************************************************************************
//!	ファイル名		Class_SceneStage4.h
//
//	機能			ゲームシーンクラス、ステージ4「荒野」を定義
//	記述			上岡　純
//	プロジェクト	「」
//	更新			2009/01/27	<新規>
//***********************************************************************************
...
namespace SCE
{
	...
	//!	クラス名		CSCENE_STAGE4
	//
	//	機能			ゲームシーンクラス、ステージ4「荒野」
	//	機能概要		アドベンチャーゲームクラスを継承している
	//					ステージ4はアドベンチャーゲームモード
	//	更新			2009/01/27	<新規>
	//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	class CSCENE_STAGE4 : public CSCENE_ADVENTURE_GAME
	{
	private:		//-------------------- private --------------------//

	public:			//-------------------- public --------------------//

				CSCENE_STAGE4(SCENE_SHARE_DATA* inData);		//!< コンストラクタ
		virtual	~CSCENE_STAGE4(void);							//!< デストラクタ
