//***********************************************************************************
//!	ファイル名		Class_SceneMovie5.h
//
//	機能			ムービーシーンクラス、ムービー5[振り切られるも…]の定義
//	記述			上岡　純
//	プロジェクト	「」
//	更新			2009/02/10	<新規>
//***********************************************************************************
...
namespace SCE
{
	...
	//!	クラス名		CSCENE_MOVIE5
	//
	//	機能			ムービーシーンクラス、ムービー5[振り切られるも…]のクラス
	//	更新			2009/02/10	<新規>
	//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	class CSCENE_MOVIE5 : public CSCENE_MOVIE_BASE
	{
	private:		//-------------------- private --------------------//
	...
	public:			//-------------------- public --------------------//
				...
				CSCENE_MOVIE5(SCENE_SHARE_DATA* inData);
		virtual	~CSCENE_MOVIE5(void);
