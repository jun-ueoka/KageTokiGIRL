//***********************************************************************************
//!	ファイル名		Class_SceneMovie6.h
//
//	機能			ムービーシーンクラス、ムービー6[敵を追って…]の定義
//	記述			上岡　純
//	プロジェクト	「」
//	更新			2009/02/10	<新規>
//***********************************************************************************
...
namespace SCE
{
	...
	//!	クラス名		CSCENE_MOVIE6
	//
	//	機能			ムービーシーンクラス、ムービー6[敵を追って…]のクラス
	//	更新			2009/02/10	<新規>
	//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	class CSCENE_MOVIE6 : public CSCENE_MOVIE_BASE
	{
	private:		//-------------------- private --------------------//
	...
	public:			//-------------------- public --------------------//
				...
				CSCENE_MOVIE6(SCENE_SHARE_DATA* inData);
		virtual	~CSCENE_MOVIE6(void);
