...
//
//	機能			ムービーシーンクラス、ムービー4[標的「カゲオ＆カゲミ」]の実装
//	記述			上岡　純
//	プロジェクト	「」
//	更新			2009/02/17	<新規>
//***********************************************************************************
...
namespace SCE
{
	...
	//	更新		2009/02/17	<新規>
	//================================================================================
	CSCENE_MOVIE4::CSCENE_MOVIE4(SCENE_SHARE_DATA* inData)	:
	//!	ゲームシーン
	CSCENE_MOVIE_BASE(eSCENE_CHAPTER2_MOVIE4, eSCENE_CHAPTER2_STAGE4, inData)
	{
	//	初期化
		this->camera	= NULL;
		this->kageo		= NULL;
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE4::デストラクタ
	//
	//	更新		2009/02/17	<新規>
	//================================================================================
	CSCENE_MOVIE4::~CSCENE_MOVIE4(void)
	{
	//	解放
		sceneFinishalize();
	}
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE4::sceneInitialize
	//
	//	機能		初期化
	...
	//================================================================================
	void
	CSCENE_MOVIE4::sceneInitialize(int inStageNum)
	{
	//	ムービーの初期化
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE4::sceneFinishalize
	//
	//	機能		解放
	//	更新		2009/02/17	<新規>
	//================================================================================
	void
	CSCENE_MOVIE4::sceneFinishalize(void)
	{
	//	解放
	...
	//================================================================================
	SCENE_FLAG
	CSCENE_MOVIE4::sceneMain(CINPUT* input)
	{
	//	処理
		this->execute(input);
	//	描画
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE4::executeInstantChengeMovieSpeed
	//
	//	機能		ムービー処理速度変更時処理
	//	更新		2009/02/15	<新規>
	//================================================================================
	void
	CSCENE_MOVIE4::executeInstantChengeMovieSpeed(void)
	{
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE4::executeProcOnce
	//
	//	機能		即時処理実行
	//	引数		inProc		処理番号
	//	更新		2009/02/17	<新規>
	//================================================================================
	void
	CSCENE_MOVIE4::executeProcOnce(int inProc)
	{
	//	処理番号で分岐
		switch(inProc)
		{
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE4::executeProc
	//
	//	機能		処理実行
	//	引数		inProc		処理番号
	//	更新		2009/02/17	<新規>
	//================================================================================
	void
	CSCENE_MOVIE4::executeProc(int inProc)
	{
	//	処理番号で分岐
		switch(inProc)
		{
	...
	//================================================================================
	//!	メソッド名	CSCENE_MOVIE4::updateLight
	//
	//	機能		ライトの更新
	//	更新		2009/02/17	<新規>
	//================================================================================
	void
	CSCENE_MOVIE4::updateLight(void)
	{
	//	ライトの更新
	...
	//================================================================================
	void
	CSCENE_MOVIE4::execute(CINPUT* input)
	{
	//	即時処理データの更新処理
		this->checkProcOnce();
	//	処理データの更新処理
