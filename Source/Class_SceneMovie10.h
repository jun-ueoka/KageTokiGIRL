//***********************************************************************************
//!	ファイル名		Class_SceneMovie10.h
//
//	機能			ムービーシーンクラス、ムービー10[脱出成功!]の定義
//	記述			上岡　純
//	プロジェクト	「」
//	更新			2009/02/10	<新規>
//***********************************************************************************
...
namespace SCE
{
	...
	//!	クラス名		CSCENE_MOVIE10
	//
	//	機能			ムービーシーンクラス、ムービー10[脱出成功!]のクラス
	//	更新			2009/02/10	<新規>
	//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	class CSCENE_MOVIE10 : public CSCENE_MOVIE_BASE
	{
	private:		//-------------------- private --------------------//
	...
	public:			//-------------------- public --------------------//
				...
				CSCENE_MOVIE10(SCENE_SHARE_DATA* inData);
		virtual	~CSCENE_MOVIE10(void);
